...
UPN01_hla_NV = UPN01_hla %>%  ungroup %>% filter(timing_classification %in% c("alpha_0", "alpha_1"), 
                                         PASS == TRUE)
UPN02_hla_NV = UPN02_hla %>% filter(timing_classification == "alpha_shared",
                            VAF.PRE<0.35, 
                            PASS == TRUE)
UPN04_hla_NV = UPN04_hla %>% ungroup %>% filter(timing_classification %in% c("alpha"), 
                                        PASS == TRUE)
UPN05_hla_NV = UPN05_hla %>% filter(timing_classification %in% c("alpha", "beta"), 
                            PASS == TRUE)
UPN10_hla_NV = UPN10_hla %>% filter(timing_classification %in% c("alpha_0", "alpha", "beta_subclonal"), 
                            PASS == TRUE)
UPN11_hla_NV = UPN11_hla %>% filter(timing_classification %in% c("alpha_0", "alpha", "beta"), 
                            PASS == TRUE)
...
data <- list(UPN01_NV = UPN01_NV, UPN02_NV = UPN02_NV, UPN04_NV = UPN04_NV, UPN05_NV = UPN05_NV, UPN10_NV = UPN10_NV, UPN11_NV = UPN11_NV, UPN01_hla_NV=UPN01_hla_NV, UPN02_hla_NV = UPN02_hla_NV, UPN04_hla_NV = UPN04_hla_NV,  UPN05_hla_NV = UPN05_hla_NV, UPN10_hla_NV = UPN10_hla_NV, UPN11_hla_NV = UPN11_hla_NV)

names <- c("UPN01_NV","UPN02_NV","UPN04_NV","UPN05_NV","UPN10_NV", "UPN11_NV", "UPN01_hla_NV", "UPN02_hla_NV", "UPN04_hla_NV", "UPN05_hla_NV", "UPN10_hla_NV", "UPN11_hla_NV")
